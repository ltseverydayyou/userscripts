// ==UserScript==
// @name         Откриване на медийни адреси (с потвърждение)
// @namespace    http://tampermonkey.net/
// @version      0.4bg
// @description  Открива mp3/mp4/m3u8 и др. чрез DOM + мрежови заявки и пита дали да отвори списък с линковете в нов раздел
// @author       you
// @match        *://*/*
...
(function() {
    ...
    function tryAddUrl(raw) {
        ...
        found.add(url);
        console.log('[Търсач на медии] засечен адрес:', url);
        schedulePrompt();
    }
